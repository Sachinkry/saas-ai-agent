            ...
            participant={
                {
                    ...
                    image: data?.user.image || GenerateAvatarUri({ seed: data?.user.name || "User", variant: "initials" }),
...
const AllowBrowserPermission = () => {
    return (
        <p className="text-sm">
            Please grant browser permissions to access your camera and microphone.
        </p>
    )
}
